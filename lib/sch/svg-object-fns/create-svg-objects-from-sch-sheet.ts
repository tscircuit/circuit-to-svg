...
const SHEET_STROKE_WIDTH = 0.2 / SCHEMATIC_UNIT_TO_MM
const SHEET_LABEL_FONT_SIZE = 3 / SCHEMATIC_UNIT_TO_MM
...
export function createSvgObjectsFromSchematicSheet({
  ...
  const layout = getSchematicSheetLayout(
    schematicSheet.sheet_size,
    schematicSheet.sheet_width,
    schematicSheet.sheet_height,
  )
