...
export function getViaTentingPanel(
  ...
  return [
    ...
    note(
      "T/B = tented_on_top / tented_on_bottom; unset inherits this board",
      0,
      35,
    ),
...
function createBoard(
  ...
  return [
    ...
    note("T/B: unset / unset", x - 39, 11),
    note("T/B: false / false", x - 13, 11),
    note("T/B: true / true", x + 13, 11),
    ...
    note("T/B: unset / unset", x - 39, -13),
    note("T/B: false / false", x - 13, -13),
    note("T/B: true / true", x + 13, -13),
