...
test("getComprehensivePcbBounds includes a circle plated hole's pad extent", () => {
...
test("getComprehensivePcbBounds includes a circular_hole_with_rect_pad's pad extent", () => {
